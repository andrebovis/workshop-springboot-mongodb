package com.andrebovis.workshopmongo.config;
...
import com.andrebovis.workshopmongo.dto.AuthorDTO;
...
public class Instantiation implements  CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/08/1954"), "para mano", "ah va", new AuthorDTO(maria));
